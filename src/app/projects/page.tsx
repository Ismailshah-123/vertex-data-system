...
const PROJECTS = [
  ...
  },
  {
    ...
    summary: "A full adversarial assessment of your existing LLM or ML deployment — prompt injection, data poisoning, model inversion, and OWASP LLM Top 10 coverage.",
    timeline: "2–3 weeks",
    color: "#9b5de5",
